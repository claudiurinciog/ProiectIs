...
session_start();
    ...
    $u_id=$_SESSION['u_id'];
        ...
        $q2=mysqli_fetch_assoc($conn,$result);
        $a_no=$q2['a_no'];
    
        $result1=mysqli_query($conn,"SELECT u_name FROM user where u_id='$u_id'");
        $q2=mysqli_fetch_assoc($conn,$result1);
        $u_name=$q2['u_name'];
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<form action="#" method="post" style="color: gray">CNP
					<input type="text"  name="CNP" placeholder="CNP" required="" disabled value=<?php echo "$a_no"; ?>>
				...
				<div class="top-w3-agile" style="color: gray">Location of Crime
                    ...
                    <select class="form-control" name="location">
                        ...
                        while($row=mysqli_fetch_array($conn,$loc))
                        {
                            ?>
...
<div style="position: relative;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Police Management System 2021</b></h4>
</div>
