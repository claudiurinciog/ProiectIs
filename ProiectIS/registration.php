     ...
     function f1()
        {
            ...
            var sta4=document.getElementById("CNP").value;
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php"><b>Police Management System</b></a>
    </div>
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">CNP</p><input type="text"  name="CNP" minlength="12" maxlength="12" required pattern="[123456789][0-9]{11}" id="CNP" onfocusout="f1()"/>
					...
					<div class="right-agileits">
						<p style="color:#dfdfdf">Mobile</p><input type="text"  name="mobile_number" required pattern="+40213-564-864" minlength="10" maxlength="10" id="mobno" onfocusout="f1()"/>
					</div>
